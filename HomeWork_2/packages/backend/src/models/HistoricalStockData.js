...
var HistoricalStockData = function () {
    var _classDecorators = [(0, sequelize_typescript_1.Table)({ tableName: 'historical_stock_data', timestamps: true })];
    var _classDescriptor;
    var _classExtraInitializers = [];
    var _classThis;
    var _classSuper = sequelize_typescript_1.Model;
    var _publisherCode_decorators;
    var _publisherCode_initializers = [];
    var _publisherCode_extraInitializers = [];
    ...
    var HistoricalStockData = _classThis = /** @class */ (function (_super) {
        __extends(HistoricalStockData_1, _super);
        function HistoricalStockData_1() {
            var _this = _super !== null && _super.apply(this, arguments) || this;
            _this.publisherCode = __runInitializers(_this, _publisherCode_initializers, void 0);
            _this.datePublished = (__runInitializers(_this, _publisherCode_extraInitializers), __runInitializers(_this, _datePublished_initializers, void 0));
            ...
            _this.createdAt = (__runInitializers(_this, _totalTurnoverDenars_extraInitializers), __runInitializers(_this, _createdAt_initializers, void 0));
        ...
        return HistoricalStockData_1;
    }(_classSuper));
    __setFunctionName(_classThis, "HistoricalStockData");
    (function () {
        var _a;
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create((_a = _classSuper[Symbol.metadata]) !== null && _a !== void 0 ? _a : null) : void 0;
        _publisherCode_decorators = [(0, sequelize_typescript_1.Column)({ field: 'publisherCode', type: sequelize_typescript_1.DataType.STRING })];
        ...
        __esDecorate(null, null, _publisherCode_decorators, { kind: "field", name: "publisherCode", static: false, private: false, access: { has: function (obj) { return "publisherCode" in obj; }, get: function (obj) { return obj.publisherCode; }, set: function (obj, value) { obj.publisherCode = value; } }, metadata: _metadata }, _publisherCode_initializers, _publisherCode_extraInitializers);
        ...
        HistoricalStockData = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return HistoricalStockData = _classThis;
}();
exports.default = HistoricalStockData;
